                            ...
                            children = [
                                ...
                                render.Row(
                                    ...
                                    children = [
                                        render.Column(
                                            children = [
                                                render.Box(width = 64, height = 12, color = "#000000", child = render.Row(expanded = True, main_align = "start", cross_align = "center", children = [
                                                    render.Image(awayLogo, width = 30, height = 30),
                                                    render.Box(width = 34, height = 12, child = render.Text(content = awayScore, color = awayScoreColor, font = "terminus-16")),
                                                ])),
                                                render.Box(width = 64, height = 12, color = "#000000", child = render.Row(expanded = True, main_align = "start", cross_align = "center", children = [
                                                    render.Image(homeLogo, width = 30, height = 30),
                                                    render.Box(width = 34, height = 12, child = render.Text(content = homeScore, color = homeScoreColor, font = "terminus-16")),
                                                ])),
                                            ],
                                        ),
                                    ],
